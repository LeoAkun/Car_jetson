...
def generate_launch_description():
    ...
    # 地图路径
    map_dir = "/home/akun/workspace/CAR/utils/pcd2pgm/pgm/sim/sim_map.yaml"

    # nav2配置路径
    nav2_dir = get_package_share_directory('nav2')
    params_dir = os.path.join(nav2_dir, 'config', 'nav2_sim_params.yaml')
    ...
    pointcloud2d_to_laser = launch_ros.actions.Node(
        ...
        remappings=[('cloud_in', '/livox/pointcloud'),
                        ('scan', '/scan')],
        parameters=[{
    ...
    return launch.LaunchDescription([
        ...
        launch.actions.IncludeLaunchDescription(
            ...
            PythonLaunchDescriptionSource(
                [nav2_bringup_dir, '/launch', '/bringup_launch_without_amcl.py']), # 改
            # 使用 Launch 参数替换原有参数
            launch_arguments={
                'map': map_yaml_path,
