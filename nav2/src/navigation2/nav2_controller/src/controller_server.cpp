...
void ControllerServer::computeAndPublishVelocity()
{
  ...
  try {
    cmd_vel_2d = // 调用插件，将位姿传给插件
      ...
      // std::cout << "\n-----------------------------\n";
      // std::cout << "当前控制器: " << current_controller_ << std::endl;
      // std::cout << "cmd_vel_2d.twist.linear.x: " << cmd_vel_2d.twist.linear.x << " m/s\n";
      // std::cout << "cmd_vel_2d.twist.linear.y: " << cmd_vel_2d.twist.linear.y << " m/s\n";
      // std::cout << "cmd_vel_2d.twist.linear.z: " << cmd_vel_2d.twist.linear.z << " m/s\n";
      // std::cout << "cmd_vel_2d.twist.angular.x: " << cmd_vel_2d.twist.angular.x << " rad/s\n";
      // std::cout << "cmd_vel_2d.twist.angular.y: " << cmd_vel_2d.twist.angular.y << " rad/s\n";
      // std::cout << "cmd_vel_2d.twist.angular.z: " << cmd_vel_2d.twist.angular.z << " rad/s\n";
      // std::cout << "-----------------------------\n" << std::endl;
  ...
  feedback->distance_to_goal = // 计算剩余距离
