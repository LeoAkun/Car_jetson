...
public:
        ...
        ParamServer("lio_sam_featureExtraction", options)
    {
        subLaserCloudInfo = create_subscription<lio_sam::msg::CloudInfo>(
            ...
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1)); // 订阅去畸变后的点云
    ...
    void calculateSmoothness()
    {
        ...
        for (int i = 5; i < cloudSize - 5; i++)
        {
            ...
            cloudLabel[i] = 0;
            // 存储 cloudSmoothness for sorting
